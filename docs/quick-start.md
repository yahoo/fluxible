...
From here, we recommend learning about [stores](api/Stores.md), [actions](api/Actions.md), and React integration with the [FluxibleComponent](api/FluxibleComponent.md) and the [FluxibleMixin](api/FluxibleMixin).
