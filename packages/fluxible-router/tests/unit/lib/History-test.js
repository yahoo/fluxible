...
describe('History', function () {
    ...
    describe('pushState', function () {
        it ('has pushState', function () {
            ...
            expect(testResult.pushState.state).to.eql({origUrl: '/currentUrl', foo: 'bar', fluxible: true});
            ...
            expect(testResult.pushState.state).to.eql({origUrl: '/url', foo: 'bar', fluxible: true});
            expect(testResult.pushState.title).to.equal('t');
            ...
            expect(testResult.pushState.state).to.eql({origUrl: '/url?a=b&x=y', foo: 'bar', fluxible: true});
            ...
            expect(testResult.pushState.state).to.eql({origUrl: unicodeUrl, foo: 'bar', fluxible: true});
            expect(testResult.pushState.title).to.equal('tt');
    ...
    describe('replaceState', function () {
        it ('has pushState', function () {
            ...
            expect(testResult.replaceState.state).to.eql({origUrl: '/currentUrl', foo: 'bar', fluxible: true});
            ...
            expect(testResult.replaceState.state).to.eql({origUrl: '/url', foo: 'bar', fluxible: true});
            expect(testResult.replaceState.title).to.equal('t');
            expect(testResult.replaceState.url).to.equal('/url');
            expect(windowMock.HTML5.document.title).to.equal('t');

            history.replaceState({foo: 'bar'}, 'tt', '/url?a=b&x=y');
            expect(testResult.replaceState.state).to.eql({origUrl: '/url?a=b&x=y', foo: 'bar', fluxible: true});
